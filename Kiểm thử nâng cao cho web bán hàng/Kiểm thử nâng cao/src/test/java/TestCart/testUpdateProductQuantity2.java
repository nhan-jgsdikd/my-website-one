...
public class testUpdateProductQuantity2 {
    ...
    public void testUpdateProductQuantity() {
        ...
        try {
            ...
            // Tăng số lượng sản phẩm 2 lần
            WebElement increaseButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".input-group button:last-child")));
            increaseButton.click();
            System.out.println("Đã nhấn nút tăng số lượng lần 1.");

            // Tăng số lượng sản phẩm 2 lần
            WebElement increaseButtons = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".input-group button:last-child")));
            increaseButtons.click();
            System.out.println("Đã nhấn nút tăng số lượng lần 2.");

            // Giảm số lượng sản phẩm 1 lần
            WebElement decreaseButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".input-group button:first-child")));
            decreaseButton.click();
            System.out.println("Đã nhấn nút giảm số lượng.");
